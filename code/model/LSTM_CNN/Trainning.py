...
from LSTM_CNN import LSTMCNN  # 导入CNN_LSTM


# 定义常量
dir_train = 'D:/ResearchSpace/task/gestureRecognition/data/DatasetSlide/'
dir_test = 'D:/ResearchSpace/task/gestureRecognition/GestureRecognition/data/train/'
