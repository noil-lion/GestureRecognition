...
seq_length = 400
k_split_value = 5
dir_train = 'D:/ResearchSpace/task/gestureRecognition/GestureRecognition/data/DatasetSlide/'
...
Train_Dataset = CustomDataset(dir_train+label_dir, dir_train+sample_dir, 2400, (400, 6), 'train')
Test_Dataset = CustomDataset(dir_test+label_dir, dir_test+sample_dir, 2400, (400, 6), 'train')
